...
#--------------------------------------------------------------------------
tags = ['adverb', 'pronoun', 'noun', 'interjection', 'conjunction', 'adjective', 'verb', 'preposition']
...
def main():
	...
	filepath = ["./data/lambani_training.txt"]
	languages = ["lambani"]
...
if __name__ == "__main__":
	try:
		...
		if len(sys.argv) == 3:
			...
			print ("Example: python supervised.py 0 ./data/lambani_testing.txt")
